...
(function(v, m) {
  ...
  function P(a, b, c, d) {
    ...
    if (Array.isArray(a))
      ...
      (null === a || "object" !== typeof a ? (g = null) : ((g = (ma && a[ma]) || a["@@iterator"]), (g = "function" === typeof g ? g : null)),
      "function" === typeof g)
    )
      for (a = g.call(a), f = 0; !(e = a.next()).done; ) (e = e.value), (g = b + Q(e, f++)), (p += P(e, g, c, d));
    else if ("object" === e)
      throw ((c = "" + a), Error(v(31, "[object Object]" === c ? "object with keys {" + Object.keys(a).join(", ") + "}" : c, "")));
    return p;
  }
  function R(a, b, c) {
  ...
  x = {
    ...
    createContext: function(a, b) {
      void 0 === b && (b = null);
      a = { $$typeof: Da, _calculateChangedBits: b, _currentValue: a, _currentValue2: a, _threadCount: 0, Provider: null, Consumer: null };
